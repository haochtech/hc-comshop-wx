...
Page({
    ...
    onLoad: function(o) {
        ...
        var t = wx.getStorageSync("community"),
            n = t && t.communityId || "";
        if (n) console.log("step3"), e(), d();
        else {
            var a = {};
            void 0 !== o.community_id && 0 < o.community_id && (a.communityId = o.community_id), util.getCommunityInfo(a).then(function(t) {
    ...
    authSuccess: function() {
        var t = this.goodId,
            ...
            e = a && a.communityId || this.community_id || "";
        wx.redirectTo({
