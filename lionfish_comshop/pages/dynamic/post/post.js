...
Page({
    ...
    previewImg: function(t) {
        var e = t.currentTarget.dataset.imgidx,
            a = this.imgs;
        wx.previewImage({
            current: a[e],
            urls: a,
    ...
    deleteImg: function(t) {
        var e = this.data.thumb_img,
            a = t.currentTarget.dataset.imgidx;
    ...
    formSubmit: function(t) {
        ...
        if (e) {
            var a = this.data.quanInfo.group_id,
                o = this.data.gid,
                i = this.orign_image,
                s = this.is_share;
            app.util.request({
