var _extends = Object.assign || function(e) {
        ...
        return e
    }, _WxValidate = require("../../utils/WxValidate.js"),
    _WxValidate2 = _interopRequireDefault(_WxValidate);
...
Page({
    ...
    radioChange: function(e) {
        ...
        if ("method" == t) this.is_modify_shipping_method = e.detail.value;
        else if ("fare" == t) {
    ...
    initValidate: function() {
        this.WxValidate = new _WxValidate2.
        default ({
            head_name: {
                required: !0,
                minlength: 1
    ...
    switchChange: function(e) {
        var t = e.detail.value ? 0 : 1,
            a = this.data.headInfo,
            i = a && (a.id || 0),
    ...
    infoFormSubmit: function(e) {
        ...
        var i = this.is_modify_shipping_method,
            s = this.is_modify_shipping_fare,
            o = Object.assign({}, t, {
