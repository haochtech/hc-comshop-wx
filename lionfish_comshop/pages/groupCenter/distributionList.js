...
Page({
    data: (_data = {
        ...
        permoney: 0,
        communnityId: ""
    }, _defineProperty(_data, "loadText", ""), _defineProperty(_data, "disUserId", ""), _defineProperty(_data, "no_order", 0), _defineProperty(_data, "page", 1), _defineProperty(_data, "hide_tip", !0), _defineProperty(_data, "order", []), _defineProperty(_data, "tip", "正在加载"), _data),
    onLoad: function(t) {
