    ...
    goUse: function(t) {
        ...
        if (e.length >= a) if (0 == e[a].is_limit_goods_buy) wx.switchTab({
            ...
            var i = e[a].limit_goods_list,
                s = "";
            s = 1 < i.split(",").length ? "/lionfish_comshop/pages/type/result?type=2&good_ids=" + i : "/lionfish_comshop/pages/goods/goodsDetail?id=" + i, wx.navigateTo({
                url: s
            })
