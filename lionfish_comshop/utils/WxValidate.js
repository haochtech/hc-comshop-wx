...
var WxValidate = function() {
    ...
    return _createClass(n, [{
        ...
        value: function() {
            ...
            n.methods = {
                required: function(t, e) {
                    ...
                    else if ("boolean" == typeof t) return !0;
                    return 0 < t.length
                },
                email: function(t) {
        ...
        value: function(n, t) {
            ...
            } : (void 0 === t || (2 < arguments.length && t.constructor !== Array && (t = Array.from(arguments).slice(1)), t.constructor !== Array && (t = [t]), t.forEach(function(t, e) {
        ...
        value: function(t, e) {
            var n = this.messages[t],
                i = "object" === (void 0 === n ? "undefined" : _typeof(n));
            if (n && i) return n[e.method]
        }
    }, {
        key: "defaultMessage",
        value: function(t, e) {
            var n = this.customMessage(t, e) || this.defaults.messages[e.method],
                i = void 0 === n ? "undefined" : _typeof(n);
            return "undefined" === i ? n = "Warning: No message defined for " + e.method + "." : "function" === i && (n = n.call(this, e.parameters)), n
        }
    }, {
        key: "formatTplAndAdd",
        value: function(t, e, n) {
