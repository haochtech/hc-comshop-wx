...
default = {
    ...
    interval: function(t) {
        ...
        if (e <= 0) return app.globalData.timer.remove(this.$data.timer[t]), this.$data.actEndMap[t] || (a["actEndMap." + t] = !0), a["countDownMap." + t] = {
            day: "0",
            second: "00",
            minute: "00",
            hour: "00"
        ...
        var r = Math.ceil(e / 1e3),
            n = parseInt(r / 86400),
            i = r % 86400,
            o = (0, timeFormat.formatNumber)(parseInt(i / 3600));
        i %= 3600;
        var m = {
            day: n,
            hour: o,
        ...
        this.$data.actEndMap[t] && (a["actEndMap." + t] = !1), a["countDownMap." + t] = m, this.setData(a)
    }
};