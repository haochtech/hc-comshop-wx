var _extends = Object.assign || function(r) {
        ...
        if (Symbol.iterator in Object(r)) return function(r, e) {
            var t = [],
                ...
                i = void 0;
            try {
                for (var a, c = r[Symbol.iterator](); !(n = (a = c.next()).done) && (t.push(a.value), !e || t.length !== e); n = !0);
            } catch (r) {
                o = !0, i = r
            } finally {
                try {
...
var originProperties = ["data", "properties", "options"],
    originMethods = ["onLoad", "onReady", "onShow", "onHide", "onUnload", "onPullDownRefresh", "onReachBottom", "onShareAppMessage", "onPageScroll", "onTabItemTap"];
    ...
    return Object.entries || (Object.entries = function(r) {
        ...
        try {
            for (var i, o = function() {
                var r = _slicedToArray(i.value, 2),
                    e = r[0],
                    n = r[1];
                if (originProperties.includes(e)) c[e] = _extends({}, n, c[e]);
                else if (originMethods.includes(e)) {
                    var o = c[e];
                    c[e] = function() {
