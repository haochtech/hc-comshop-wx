...
Page({
    ...
    bindPickerChange: function(t) {
        ...
        var e = this.data.formArr,
            a = (t.currentTarget.dataset.name, t.currentTarget.dataset.idx),
            i = t.detail.value,
            s = this.data.commiss_diy_form,
            r = {
                type: "select",
                name: s[a].title,
