...
Page({
    ...
    changeTabs: function(t) {
        var a = this,
            e = t.currentTarget.dataset.type || 0;
        ...
        app.util.request({
            ...
            success: function(t) {
                if (wx.hideLoading(), wx.stopPullDownRefresh(), 0 == t.data.code) {
                    var a = t.data.data,
                        e = {};
                    1 == r && 0 == a.length && (e.showEmpty = !0);
                    var o = s.data.list;
                    a = a.concat(o), e.list = a, e.loadOver = !0, e.loadText = s.data.loadMore ? "加载中..." : "没有更多商品了~", s.setData(e, function() {
                        s.pageNum += 1
                    })
                } else {
                    var n = {
    ...
    orderPay: function(t) {
        ...
        wx.showLoading(), app.util.request({
            ...
            method: "POST",
            success: function(t) {
                wx.hideLoading(), 0 == t.data.code ? wx.requestPayment({
                    appId: t.data.appId,
