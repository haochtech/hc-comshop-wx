...
Page({
    ...
    noMore: !1,
    onLoad: function(t) {
        "undefined" != t.share_id && 0 < t.share_id && wx.setStorageSync("share_id", t.share_id), this.getData()
    },
    ...
    openSku: function(t) {
        if (this.authModal()) {
            var a = t.currentTarget.dataset.idx,
                e = this.data.specialList[a].list || [];
            this.setData({
                list: e
            });
            var i = this,
                s = e[t.currentTarget.dataset.gidx],
                n = s.actId,
                o = s.skuList;
            i.setData({
                addCar_goodsid: n
            ...
            if (0 < r.length) {
                ...
                for (var h = "", g = 0; g < u.length; g++) g == u.length - 1 ? h += u[g].id : h = h + u[g].id + "_";
                var p = o.sku_mu_list[h];
                i.setData({
                    sku: u,
                    sku_val: 1,
                    cur_sku_arr: p,
