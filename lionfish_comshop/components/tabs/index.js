...
Component({
    ...
    ready: function() {
        this.tabsWidth = [], this.tabsLeft = [], this.screenWidth = wx.getSystemInfoSync().screenWidth, this.setData({
    ...
    methods: {
        ...
        centerTheTab: function(t, e) {
            var a = e.width,
                i = (e.left, this.tabsWidth.slice(0, t).reduce(function(t, e) {
                    return t + e + 25
                }, 15));
            this.setData({
        ...
        resetIndicator: function() {
            ...
            a.translateX(0).width(e).step(), this.setData({
                scrollLeft: 0,
                indicatorAnamationData: a.export()
            })
        }
    }
});