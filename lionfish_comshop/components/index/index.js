    ...
    methods: {
        changeGPSCommunity: function() {
            ...
            var e = getCurrentPages(),
                a = 1; - 1 < e[e.length - 2].route.indexOf("/position/search") && (a = 2), t.globalData.changeCity = this.data.localCity, wx.navigateBack({
                delta: a
            })
        },
        ...
        _updateDataChange: function() {
            var t = this,
                a = this.getRelationNodes("../index-item/index"),
                e = a.length,
                i = this.data.fixedData;
        ...
        getCurrentItem: function(t) {
            var e = this.getRelationNodes("../index-item/index"),
                a = {};
        ...
        handlerTouchMove: function(t) {
            var e = this.data,
                a = (t.touches[0] || {}).pageY - e.startTop,
                i = Math.ceil(a / e.itemHeight);
