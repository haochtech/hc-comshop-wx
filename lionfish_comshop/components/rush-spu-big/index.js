...
Component({
    properties: {
        spuItem: {
            ...
            observer: function(t) {
                var e = "/lionfish_comshop/pages/goods/goodsDetail?&id=" + t.actId;
                this.setData({
                    url: e
                })
            }
        ...
        addCart: function(t) {
            ...
            if ("plus" == t.type) {
                ...
                util.addCart(u).then(function(t) {
                    ...
                    } else if (4 == t.data.code) o.setData({
                        needAuth: !0
                    }), o.triggerEvent("authModal", !0);
                    ...
                    } else console.log(t), o.triggerEvent("changeCartNum", t.data.total), o.setData({
                ...
                success: function(t) {
                    3 == t.data.code ? wx.showToast({
                        ...
                        icon: "none",
                        duration: 2e3
                    }) : 4 == t.data.code ? (o.setData({
                        needAuth: !0
                    }), o.triggerEvent("authModal", !0)) : (o.triggerEvent("changeCartNum", t.data.total), o.setData({
                        number: t.data.cur_count
                    }), status.indexListCarCount(s, t.data.cur_count))
                }
            })
