...
function r(e, r) {
    ...
    for (var o = 0; o < e.length; ++o) {
        var i = t + " sub-extension " + o + ": ",
            l = e[o];
        if ("object" !== (void 0 === l ? "undefined" : n(l))) return a.valid = !1, a.error = i + "must be an object, but " + (void 0 === l ? "undefined" : n(l)) + " given", a;
        if (!s.helper.isString(l.type)) return a.valid = !1, a.error = i + 'property "type" must be a string, but ' + n(l.type) + " given", a;
        ...
        if ("listener" === c) {
            if (s.helper.isUndefined(l.listeners)) return a.valid = !1, a.error = i + '. Extensions of type "listener" must have a property called "listeners"', a
        } else if (s.helper.isUndefined(l.filter) && s.helper.isUndefined(l.regex)) return a.valid = !1, a.error = i + c + ' extensions must define either a "regex" property or a "filter" method', a;
        if (l.listeners) {
            if ("object" !== n(l.listeners)) return a.valid = !1, a.error = i + '"listeners" property must be an object but ' + n(l.listeners) + " given", a;
            for (var u in l.listeners) if (l.listeners.hasOwnProperty(u) && "function" != typeof l.listeners[u]) return a.valid = !1, a.error = i + '"listeners" property must be an hash of [event name]: [callback]. listeners.' + u + " must be a function but " + n(l.listeners[u]) + " given", a
        }
        if (l.filter) {
            if ("function" != typeof l.filter) return a.valid = !1, a.error = i + '"filter" must be a function, but ' + n(l.filter) + " given", a
        } else if (l.regex) {
            if (s.helper.isString(l.regex) && (l.regex = new RegExp(l.regex, "g")), !l.regex instanceof RegExp) return a.valid = !1, a.error = i + '"regex" property must either be a string or a RegExp object, but ' + n(l.regex) + " given", a;
            if (s.helper.isUndefined(l.replace)) return a.valid = !1, a.error = i + '"regex" extensions must implement a replace string or function', a
        }
    }
    return a
}
...
s.helper.matchRecursiveRegExp = function(e, r, t, n) {
    ...
    ! function() {
        ...
        return r = (r = (r = (r = r.replace(/~/g, "~T")).replace(/\$/g, "~D")).replace(/\r\n/g, "\n")).replace(/\r/g, "\n"), u.smartIndentationFix && (t = (e = r).match(/^\s*/)[0].length, n = new RegExp("^\\s{0," + t + "}", "gm"), r = e.replace(n, "")), r = r, r = s.subParser("detab")(r, u, a), r = s.subParser("stripBlankLines")(r, u, a), s.helper.forEach(p, function(e) {
            r = s.subParser("runExtension")(e, r, u, a)
        }), r = s.subParser("hashPreCodeTags")(r, u, a), r = s.subParser("githubCodeBlocks")(r, u, a), r = s.subParser("hashHTMLBlocks")(r, u, a), r = s.subParser("hashHTMLSpans")(r, u, a), r = s.subParser("stripLinkDefinitions")(r, u, a), r = s.subParser("blockGamut")(r, u, a), r = s.subParser("unhashHTMLSpans")(r, u, a), r = (r = (r = s.subParser("unescapeSpecialChars")(r, u, a)).replace(/~D/g, "$$")).replace(/~T/g, "~"), s.helper.forEach(h, function(e) {
            r = s.subParser("runExtension")(e, r, u, a)
        }), r
    ...
    var t = function(e, r, t, n, a, o, i, l) {
        ...
        return "" !== h && null !== h && (h = h.replace(/"/g, "&quot;"), d += ' title="' + (h = s.helper.escapeCharacters(h, "*_", !1)) + '"'), d + ">" + c + "</a>"
    };
    return e = (e = (e = (e = f.converter._dispatch("anchors.before", e, r, f)).replace(/(\[((?:\[[^\]]*]|[^\[\]])*)][ ]?(?:\n[ ]*)?\[(.*?)])()()()()/g, t)).replace(/(\[((?:\[[^\]]*]|[^\[\]])*)]\([ \t]*()<?(.*?(?:\(.*?\).*?)?)>?[ \t]*((['"])(.*?)\6[ \t]*)?\))/g, t)).replace(/(\[([^\[\]]+)])()()()()()/g, t), f.converter._dispatch("anchors.after", e, r, f)
    ...
    return e = (e = (e = t.converter._dispatch("autoLinks.before", e, r, t)).replace(/<(((https?|ftp|dict):\/\/|www\.)[^'">\s]+)>/gi, n)).replace(/<(?:mailto:)?([-.\w]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)>/gi, a), r.simplifiedAutoLink && (e = (e = e.replace(/\b(((https?|ftp|dict):\/\/|www\.)[^'">\s]+\.[^'">\s]+)(?=\s|$)(?!["<>])/gi, n)).replace(/(?:^|[ \n\t])([A-Za-z0-9!#$%&'*+-/=?^_`\{|}~\.]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)(?:$|[ \n\t])/gi, a)), t.converter._dispatch("autoLinks.after", e, r, t)
}), s.subParser("blockGamut", function(e, r, t) {
    e = t.converter._dispatch("blockGamut.before", e, r, t), e = s.subParser("blockQuotes")(e, r, t), e = s.subParser("headers")(e, r, t);
    var n = s.subParser("hashBlock")("<hr />", r, t);
    return e = (e = (e = e.replace(/^[ ]{0,2}([ ]?\*[ ]?){3,}[ \t]*$/gm, n)).replace(/^[ ]{0,2}([ ]?\-[ ]?){3,}[ \t]*$/gm, n)).replace(/^[ ]{0,2}([ ]?_[ ]?){3,}[ \t]*$/gm, n), e = s.subParser("lists")(e, r, t), e = s.subParser("codeBlocks")(e, r, t), e = s.subParser("tables")(e, r, t), e = s.subParser("hashHTMLBlocks")(e, r, t), e = s.subParser("paragraphs")(e, r, t), t.converter._dispatch("blockGamut.after", e, r, t)
}), s.subParser("blockQuotes", function(e, n, a) {
    return e = (e = a.converter._dispatch("blockQuotes.before", e, n, a)).replace(/((^[ \t]{0,3}>[ \t]?.+\n(.+\n)*\n*)+)/gm, function(e, r) {
        var t = r;
        return t = (t = (t = t.replace(/^[ \t]*>[ \t]?/gm, "~0")).replace(/~0/g, "")).replace(/^[ \t]+$/gm, ""), t = s.subParser("githubCodeBlocks")(t, n, a), t = (t = (t = s.subParser("blockGamut")(t, n, a)).replace(/(^|\n)/g, "$1  ")).replace(/(\s*<pre>[^\r]+?<\/pre>)/gm, function(e, r) {
            var t = r;
    ...
    return e = (e = (e = e.replace(/&/g, "&amp;")).replace(/</g, "&lt;")).replace(/>/g, "&gt;"), s.helper.escapeCharacters(e, "*_{}[]\\", !1)
    ...
    function u(e) {
        ...
        return c.hashLinkCounts[t] ? r = t + "-" + c.hashLinkCounts[t]++ : (r = t, c.hashLinkCounts[t] = 1), !0 === n && (n = "section"), s.helper.isString(n) ? n + r : r
    }
    e = c.converter._dispatch("headers.before", e, l, c);
    var n = l.prefixHeaderId,
        p = isNaN(parseInt(l.headerLevelStart)) ? 1 : parseInt(l.headerLevelStart),
        r = l.smoothLivePreview ? /^(.+)[ \t]*\n={2,}[ \t]*\n+/gm : /^(.+)[ \t]*\n=+[ \t]*\n+/gm,
        t = l.smoothLivePreview ? /^(.+)[ \t]*\n-{2,}[ \t]*\n+/gm : /^(.+)[ \t]*\n-+[ \t]*\n+/gm;
    return e = (e = (e = e.replace(r, function(e, r) {
        var t = s.subParser("spanGamut")(r, l, c),
            n = l.noHeaderId ? "" : ' id="' + u(r) + '"',
            a = "<h" + p + n + ">" + t + "</h" + p + ">";
        ...
        var n = s.subParser("spanGamut")(t, l, c),
            a = l.noHeaderId ? "" : ' id="' + u(t) + '"',
            o = p - 1 + r.length,
            i = "<h" + o + a + ">" + n + "</h" + o + ">";
    ...
    function t(e, r, t, n, a, o, i, l) {
        ...
        if (t = t.toLowerCase(), l || (l = ""), "" === n || null === n) {
            if ("" !== t && null !== t || (t = r.toLowerCase().replace(/ ?\n/g, " ")), n = "#" + t, s.helper.isUndefined(c[t])) return e;
            n = c[t], s.helper.isUndefined(u[t]) || (l = u[t]), s.helper.isUndefined(p[t]) || (a = p[t].width, o = p[t].height)
        }
        r = r.replace(/"/g, "&quot;"), r = s.helper.escapeCharacters(r, "*_", !1);
        var h = '<img.vue src="' + (n = s.helper.escapeCharacters(n, "*_", !1)) + '" alt="' + r + '"';
        return l && (l = l.replace(/"/g, "&quot;"), h += ' title="' + (l = s.helper.escapeCharacters(l, "*_", !1)) + '"'), a && o && (h += ' width="' + (a = "*" === a ? "auto" : a) + '"', h += ' height="' + (o = "*" === o ? "auto" : o) + '"'), h + " />"
    }
    return e = (e = (e = d.converter._dispatch("images.before", e, r, d)).replace(/!\[([^\]]*?)] ?(?:\n *)?\[(.*?)]()()()()()/g, t)).replace(/!\[(.*?)]\s?\([ \t]*()<?(\S+?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(['"])(.*?)\6[ \t]*)?\)/g, t), d.converter._dispatch("images.after", e, r, d)
}), s.subParser("italicsAndBold", function(e, r, t) {
    return e = t.converter._dispatch("italicsAndBold.before", e, r, t), e = r.literalMidWordUnderscores ? (e = (e = (e = e.replace(/(^|\s|>|\b)__(?=\S)([\s\S]+?)__(?=\b|<|\s|$)/gm, "$1<strong>$2</strong>")).replace(/(^|\s|>|\b)_(?=\S)([\s\S]+?)_(?=\b|<|\s|$)/gm, "$1<em>$2</em>")).replace(/(\*\*)(?=\S)([^\r]*?\S[*]*)\1/g, "<strong>$2</strong>")).replace(/(\*)(?=\S)([^\r]*?\S)\1/g, "<em>$2</em>") : (e = e.replace(/(\*\*|__)(?=\S)([^\r]*?\S[*_]*)\1/g, "<strong>$2</strong>")).replace(/(\*|_)(?=\S)([^\r]*?\S)\1/g, "<em>$2</em>"), t.converter._dispatch("italicsAndBold.after", e, r, t)
    ...
    function i(e, r) {
        ...
        return e = (e = e.replace(/(\n)?(^[ \t]*)([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(~0|\2([*+-]|\d+[.])[ \t]+))/gm, function(e, r, t, n, a, o, i) {
            i = i && "" !== i.trim();
            var l = s.subParser("outdent")(a, p, h),
                c = "";
            return o && p.tasklists && (c = ' class="task-list-item" style="list-style-type: none;"', l = l.replace(/^[ \t]*\[(x|X| )?]/m, function() {
                var e = '<input type="checkbox" disabled style="margin: 0px 0.35em 0.25em -1.6em; vertical-align: middle;"';
                return i && (e += " checked"), e + ">"
            })), r || -1 < l.search(/\n{2,}/) ? (l = s.subParser("githubCodeBlocks")(l, p, h), l = s.subParser("blockGamut")(l, p, h)) : (l = (l = s.subParser("lists")(l, p, h)).replace(/\n$/, ""), l = u ? s.subParser("paragraphs")(l, p, h) : s.subParser("spanGamut")(l, p, h)), "\n<li" + c + ">" + l + "</li>\n"
        })).replace(/~0/g, ""), h.gListLevel--, r && (e = e.replace(/\s+$/, "")), e
    }
    function a(e, n, s) {
        var a = "ul" === n ? /^ {0,2}\d+\.[ \t]/gm : /^ {0,2}[*+-][ \t]/gm,
            r = [],
            o = "";
        if (-1 !== e.search(a)) {
            ! function e(r) {
                var t = r.search(a); - 1 !== t ? (o += "\n\n<" + n + ">" + i(r.slice(0, t), !! s) + "</" + n + ">\n\n", a = "ul" == (n = "ul" === n ? "ol" : "ul") ? /^ {0,2}\d+\.[ \t]/gm : /^ {0,2}[*+-][ \t]/gm, e(r.slice(t))) : o += "\n\n<" + n + ">" + i(r, !! s) + "</" + n + ">\n\n"
            }(e);
    ...
    }) : (r = /(\n\n|^\n?)(([ ]{0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(~0|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/gm, e = e.replace(r, function(e, r, t, n) {
    ...
    for (var n = (e = (e = (e = t.converter._dispatch("paragraphs.before", e, r, t)).replace(/^\n+/g, "")).replace(/\n+$/g, "")).split(/\n{2,}/g), a = [], o = n.length, i = 0; i < o; i++) {
        var l = n[i];
        0 <= l.search(/~(K|G)(\d+)\1/g) || (l = (l = s.subParser("spanGamut")(l, r, t)).replace(/^([ \t]*)/g, "<p>"), l += "</p>"), a.push(l)
    }
    for (o = a.length, i = 0; i < o; i++) {
        for (var c = "", u = a[i], p = !1; 0 <= u.search(/~(K|G)(\d+)\1/);) {
            var h = RegExp.$1,
                d = RegExp.$2;
            c = (c = "K" === h ? t.gHtmlBlocks[d] : p ? s.subParser("encodeCode")(t.ghCodeBlocks[d].text) : t.ghCodeBlocks[d].codeblock).replace(/\$/g, "$$$$"), u = u.replace(/(\n\n)?~(K|G)\d+\2(\n\n)?/, c), /^<pre\b[^>]*>\s*<code\b[^>]*>/.test(u) && (p = !0)
        }
        a[i] = u
    }
    ...
    return e = t.converter._dispatch("spanGamut.before", e, r, t), e = s.subParser("codeSpans")(e, r, t), e = s.subParser("escapeSpecialCharsWithinTagAttributes")(e, r, t), e = s.subParser("encodeBackslashEscapes")(e, r, t), e = s.subParser("images")(e, r, t), e = s.subParser("anchors")(e, r, t), e = s.subParser("autoLinks")(e, r, t), e = s.subParser("encodeAmpsAndAngles")(e, r, t), e = s.subParser("italicsAndBold")(e, r, t), e = (e = s.subParser("strikethrough")(e, r, t)).replace(/  +\n/g, " <br />\n"), t.converter._dispatch("spanGamut.after", e, r, t)
    ...
    return (e = (e += "~0").replace(/^ {0,3}\[(.+)]:[ \t]*\n?[ \t]*<?(\S+?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*\n?[ \t]*(?:(\n*)["|'(](.+?)["|')][ \t]*)?(?:\n+|(?=~0))/gm, function(e, r, t, n, a, o, i) {
        return r = r.toLowerCase(), c.gUrls[r] = s.subParser("encodeAmpsAndAngles")(t), o ? o + i : (i && (c.gTitles[r] = i.replace(/"|'/g, "&quot;")), l.parseImgDimensions && n && a && (c.gDimensions[r] = {
            width: n,
            height: a
        }), "")
    })).replace(/~0/, "")
    ...
    return e = (e = m.converter._dispatch("tables.before", e, v, m)).replace(/^[ \t]{0,3}\|?.+\|.+\n[ \t]{0,3}\|?[ \t]*:?[ \t]*(?:-|=){2,}[ \t]*:?[ \t]*\|[ \t]*:?[ \t]*(?:-|=){2,}[\s\S]+?(?:\n\n|~0)/gm, function(e) {
        ...
        for (r = 0; r < c.length; ++r) s.helper.isUndefined(d[r]) && (d[r] = ""), h.push((a = c[r], o = d[r], i = void 0, i = "", a = a.trim(), v.tableHeaderId && (i = ' id="' + a.replace(/ /g, "_").toLowerCase() + '"'), "<th" + i + o + ">" + (a = s.subParser("spanGamut")(a, v, m)) + "</th>\n"));
        for (r = 0; r < p.length; ++r) {
            for (var g = [], b = 0; b < h.length; ++b) s.helper.isUndefined(p[r][b]), g.push((l = p[r][b], "<td" + d[b] + ">" + s.subParser("spanGamut")(l, v, m) + "</td>\n"));
            f.push(g)
        }
        return function(e, r) {
