...
var t = /^<([-A-Za-z0-9_]+)((?:\s+[a-zA-Z_:][-a-zA-Z0-9_:.]*(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)>/,
    ...
    a = e("area,base,basefont,br,col,frame,hr,img.vue,input,link,meta,param,embed,command,keygen,source,track,wbr"),
    n = e("a,address,code,article,applet,aside,audio,blockquote,button,canvas,center,dd,del,dir,div,dl,dt,fieldset,figcaption,figure,footer,form,frameset,h1,h2,h3,h4,h5,h6,header,hgroup,hr,iframe,ins,isindex,li,map,menu,noframes,noscript,object,ol,output,p,pre,section,script,table,tbody,td,tfoot,th,thead,tr,ul,video"),
    i = e("abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,del,dfn,em,font,i,iframe,img.vue,input,ins,kbd,label,map,object,q,s,samp,script,select,small,span,strike,strong,sub,sup,textarea,tt,u,var"),
...
module.exports = function(e, f) {
    function u(e, t) {
        if (t) for (t = t.toLowerCase(), r = b.length - 1; 0 <= r && b[r] != t; r--);
        else var r = 0;
        if (0 <= r) {
    ...
    for (b.last = function() {
        ...
        else if (0 == e.indexOf("\x3c!--") ? 0 <= (h = e.indexOf("--\x3e")) && (f.comment && f.comment(e.substring(4, h)), e = e.substring(h + 3), d = !1) : 0 == e.indexOf("</") ? (p = e.match(r)) && (e = e.substring(p[0].length), p[0].replace(r, u), d = !1) : 0 == e.indexOf("<") && (p = e.match(t)) && (e = e.substring(p[0].length), p[0].replace(t, function(e, t, r, c) {
