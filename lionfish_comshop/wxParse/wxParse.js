...
function n(e, a, i, r) {
    ...
    if (d && 0 != d.images.length) {
        var s = d.images,
            g = o(e.detail.width, e.detail.height, i, r),
            l = s[a].index,
            h = "" + r,
            m = !0,
            u = !1,
...
function o(e, t, a, i) {
    ...
    return (r = g - 2 * s) < e ? (o = (n = r) * t / e, d.imageWidth = n, d.imageheight = o) : (d.imageWidth = e, d.imageheight = t), d
}
var d = e(require("./showdown.js")),
    s = e(require("./html2json.js")),
    g = 0,
    l = 0;
wx.getSystemInfo({
    success: function(e) {
    ...
    wxParse: function() {
        var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "wxParseData",
            ...
            m = {};
        if ("html" == t) m = s.
        default.html2json(n, e);
        else if ("md" == t || "markdown" == t) {
            var u = (new d.
            default.Converter).makeHtml(n);
            m = s.
            default.html2json(u, e)
        }
