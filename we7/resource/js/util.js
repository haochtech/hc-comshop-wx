...
function getSign(e, t, n) {
    ...
    for (var c = "", f = 0; f < i.length; f++) i[f] && i[f].name && i[f].value && (c += i[f].name + "=" + i[f].value, f < i.length - 1 && (c += "&"));
    return o = a(c + (n = n || app.siteInfo.token))
}
util.base64_encode = function(e) {
    ...
    var n = app.siteInfo.siteroot + "?i=" + app.siteInfo.uniacid + "&t=" + app.siteInfo.multiid + "&v=" + app.siteInfo.version + "&from=wxapp&";
    if (e && ((e = e.split("/"))[0] && (n += "c=" + e[0] + "&"), e[1] && (n += "a=" + e[1] + "&"), e[2] && (n += "do=" + e[2] + "&")), t && "object" === (void 0 === t ? "undefined" : _typeof(t))) for (var r in t) r && t.hasOwnProperty(r) && t[r] && (n += r + "=" + t[r] + "&");
    return n
    ...
    var n = wx.getStorageSync("userInfo").sessionid,
        a = r.url;
    if (-1 == a.indexOf("http://") && -1 == a.indexOf("https://") && (a = util.url(a)), getUrlParam(a, "state") || r.data && r.data.state || !n || (a = a + "&state=we7sid-" + n), !r.data || !r.data.m) {
        var i = getCurrentPages();
        i.length && (i = i[getCurrentPages().length - 1]) && i.__route__ && (a = a + "&m=" + i.__route__.split("/")[0])
    }
    var o = getSign(a, r.data);
    if (o && (a = a + "&sign=" + o), !a) return !1;
    if (r.showLoading, r.cachetime) {
        var s = t(a),
            u = wx.getStorageSync(s),
            c = Date.parse(new Date);
        if (u && u.data) {
            if (u.expire > c) return r.complete && "function" == typeof r.complete && r.complete(u), r.success && "function" == typeof r.success && r.success(u), console.log("cache:" + a), !0;
    ...
    wx.request((_defineProperty(e = {
        ...
        if (e.data.errno) {
            ...
            if (r.fail && "function" == typeof r.fail) r.fail(e);
            ...
            var n = {
                data: e.data,
                expire: c + 1e3 * r.cachetime
            };
            wx.setStorageSync(s, n)
        }
    }), _defineProperty(e, "fail", function(e) {
        wx.hideNavigationBarLoading(), wx.hideLoading();
        var t = require("md5.js")(a),
            n = wx.getStorageSync(t);
        if (n && n.data) return r.success && "function" == typeof r.success && r.success(n), console.log("failreadcache:" + a), !0;
    ...
    var r = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : "确定";
    if (!e) return !0;
    if ("object" == (void 0 === e ? "undefined" : _typeof(e)) && (t = e.redirect, n = e.type, e = e.title), t) {
        var a = t.substring(0, 9),
            i = "",
            o = "";
        "navigate:" == a ? (o = "navigateTo", i = t.substring(9)) : "redirect:" == a ? (o = "redirectTo", i = t.substring(9)) : "switchTo:" == a ? (o = "switchTab", i = t.substring(9)) : (i = t, o = "redirectTo")
    }
...
}, util.navTo = function(e) {
    if (e) {
        var t = e.substring(0, 9),
            n = "",
            r = "";
        "navigate:" == t ? (r = "navigateTo", n = e.substring(9)) : "redirect:" == t ? (r = "redirectTo", n = e.substring(9)) : "switchTo:" == t ? (r = "switchTab", n = e.substring(9)) : (n = e, r = "redirectTo"), n && wx[r]({
            url: n
        })
    }
    ...
    this.isLeapYear = function(e) {
        ...
        var n = 0,
            r = -1,
            a = t.length; - 1 < (r = e.indexOf("yyyy")) && r < a && (n = t.substr(r, 4));
        var i = 0; - 1 < (r = e.indexOf("MM")) && r < a && (i = parseInt(t.substr(r, 2)) - 1);
        var o = 0; - 1 < (r = e.indexOf("dd")) && r < a && (o = parseInt(t.substr(r, 2)));
        var s = 0;
        (-1 < (r = e.indexOf("HH")) || 1 < (r = e.indexOf("hh"))) && r < a && (s = parseInt(t.substr(r, 2)));
        var u = 0; - 1 < (r = e.indexOf("mm")) && r < a && (u = t.substr(r, 2));
        var c = 0;
