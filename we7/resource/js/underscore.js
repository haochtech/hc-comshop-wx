...
(function() {
    ...
    h.each = h.forEach = function(n, t, r) {
        var e, u;
        if (t = s(t, r), m(n)) for (e = 0, u = n.length; e < u; e++) t(n[e], e, n);
        else {
            var i = h.keys(n);
        ...
        var r, u, i = -1 / 0,
            o = -1 / 0;
        if (null == e && null != n) for (var a = 0, c = (n = m(n) ? n : h.values(n)).length; a < c; a++) r = n[a], i < r && (i = r);
        ...
        var r, u, i = 1 / 0,
            o = 1 / 0;
        if (null == e && null != n) for (var a = 0, c = (n = m(n) ? n : h.values(n)).length; a < c; a++)(r = n[a]) < i && (i = r);
        else e = v(e, t), h.each(n, function(n, t, r) {
            ((u = e(n, t, r)) < o || u === 1 / 0 && i === 1 / 0) && (i = n, o = u)
        });
        return i
    }, h.shuffle = function(n) {
        for (var t, r = m(n) ? n : h.values(n), e = r.length, u = Array(e), i = 0; i < e; i++)(t = h.random(0, i)) !== i && (u[i] = u[t]), u[t] = r[i];
        return u
    ...
    h.flatten = function(n, t) {
        ...
        var e = 0,
            u = n && n.length;
        if ("number" == typeof r) e = r < 0 ? Math.max(0, u + r) : r;
        else if (r && u) return n[e = h.sortedIndex(n, t)] === t ? e : -1;
    ...
    h.keys = function(n) {
        ...
        var e, u, i = {}, o = n;
        if (null == o) return i;
        h.isFunction(t) ? (u = h.allKeys(o), e = s(t, r)) : (u = j(arguments, !1, !1, 1), e = function(n, t, r) {
            return t in r
        }, o = Object(o));
