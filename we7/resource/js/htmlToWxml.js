var startTag = /^<([-A-Za-z0-9_]+)((?:\s+[a-zA-Z_:][-a-zA-Z0-9_:.]*(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)>/,
    ...
    HTMLParser = function(e, n) {
        ...
        for (s.last = function() {
            ...
            else if (0 == e.indexOf("\x3c!--") ? 0 <= (t = e.indexOf("--\x3e")) && (n.comment && n.comment(e.substring(4, t)), e = e.substring(t + 3), a = !1) : 0 == e.indexOf("</") ? (r = e.match(endTag)) && (e = e.substring(r[0].length), r[0].replace(endTag, c), a = !1) : 0 == e.indexOf("<") && (r = e.match(startTag)) && (e = e.substring(r[0].length), r[0].replace(startTag, o), a = !1), a) {
...
global.html2json = function(e) {
    ...
    return HTMLParser(e, {
        start: function(e, t, a) {
            ...
            debug(e);
            var t = n.shift();
            if (t.tag !== e && console.error("invalid state: mismatch end tag"), 0 === n.length) s.child.push(t);
            else {
                var a = n[0];
...
var html2wxwebview = function(e) {
    ...
    return function e(t) {
        var a = {};
        if ("root" == t.node);
        else if ("element" == t.node) switch (t.tag) {
            case "a":
                a = {
                    type: "a",
                    text: t.child[0].text
